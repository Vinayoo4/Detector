...
from .services import run_analysis, serialize_analysis, recent_analyses
...
def index():
    return render_template("index.html", form=URLForm(),
                           recent=recent_analyses(20), page_title="Detector")
...
def api_feedback():
    ...
    verdict = payload.get("verdict")   # "satisfied" or "not_satisfied"
...
@bp.route("/sw.js")
def service_worker():
    r = send_from_directory(current_app.static_folder, "sw.js",
